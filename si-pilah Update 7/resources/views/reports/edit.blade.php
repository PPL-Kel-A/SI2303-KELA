...
<head>
    ...
    <title>Edit Laporan - Si-Pilah</title>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-400">Perbarui informasi laporan Anda</p>
                </div>
            </div>
            ...
            @include('reports.components.report-form', ['action' => route('reports.update', $report->id)])
        </div>
    </div>
